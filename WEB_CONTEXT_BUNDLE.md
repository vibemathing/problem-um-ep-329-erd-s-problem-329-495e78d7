...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-329-erd-s-problem-329-495e78d7-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-329"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-329-erd-s-problem-329-495e78d7-v1",
      "problem_contract_sha256": "97a06a161d3e3d6709de522783a76550f444cce8e3de4799c683d9ef99ada520",
      "problem_id": "problem:um-ep-329-erd-s-problem-329-495e78d7",
      "route_id": "route:um-ep-329-erd-s-problem-329-495e78d7-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-329-erd-s-problem-329-495e78d7-source-fidelity-01",
      "graph_id": "graph:um-ep-329-erd-s-problem-329-495e78d7-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-329-erd-s-problem-329-495e78d7-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-329-erd-s-problem-329-495e78d7-root",
          "statement": {
          ...
          "statement_sha256": "183ba4c35e3c6b60980eefae26736e999d35c4b2385004ac15240a793b14621a"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-329-erd-s-problem-329-495e78d7-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-329-erd-s-problem-329-495e78d7-root",
      "route_id": "route:um-ep-329-erd-s-problem-329-495e78d7-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-329-4f9205972cdc",
        "url": "https://www.unsolvedmath.com/problems/EP-329"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
